# src/ui/pages/trades_downloader.py
...
st.set_page_config(page_title="Trades Downloader", layout="wide")

def _parse_yyyy_mm_dd(s: str):
    return datetime.strptime(s, "%Y-%m-%d").date()

st.subheader(" Binance Trades Downloader")
...
if run:
    try:
        ...
        if cleanup:
            # cleanup is already handled inside download_and_convert() if implemented in pipeline
            pass
